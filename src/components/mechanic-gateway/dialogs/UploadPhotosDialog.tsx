...
import { EvidenceData } from "@/types/MechanicGateway.types";
...
export const UploadPhotosDialog = ({ photos, photoDialogOpen, setPhotoDialogOpen, fileInputRef, evidenceData, setEvidenceData, createEvidence, appointment }: UploadPhotosDialogProps) => {
