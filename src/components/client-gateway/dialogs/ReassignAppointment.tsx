...
import { RescheduleData } from "@/types/ClientGateway.types";
      ...
      <DialogContent dividers>
        ...
        <Grid container spacing={2} component="form" onSubmit={submitReasign}>
          <Grid size={{ xs: 12, sm: 6 }}>
            <TextField fullWidth required type="date" label="Nueva Fecha" value={reasignForm.date} onChange={(e) => setReasignForm({ ...reasignForm, date: e.target.value })} sx={fieldSx()} />
          </Grid>
          <Grid size={{ xs: 12, sm: 6 }}>
