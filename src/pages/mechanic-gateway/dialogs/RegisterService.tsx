        ...
        <Stack spacing={2}>
          ...
          {procedureData.supplies.map((item, index) => (
            <Box key={index} sx={{ display: 'flex', gap: 1, alignItems: 'flex-start' }}>
              ...
              <TextField InputLabelProps={{ shrink: true }} type="number" value={item.amount} sx={{ width: '120px' }}
                onChange={(e) => handleQuantityChange(index, parseInt(e.target.value) || 1)} inputProps={{ min: 1 }} variant="standard" />
